...
\begin{subpart}{Conventions}
  ...
  \item If $\dual{a} \in \Gamma$ and $a \in \Delta$ then $\eta_\Gamma \odot_a \eta_\Delta$ is a proof of
        $\left(\Gamma U \Delta\right) \setminus \left\{a,\dual{a}\right\}$.
...
\begin{frame}{LowerUnits (LU)}
  ...
  \begin{subpart}{Two traversals}
    ...
    \item Delete units, fix the proof and then reintroduce the units at the bottom of the proof.
  \end{subpart}
\end{frame}
