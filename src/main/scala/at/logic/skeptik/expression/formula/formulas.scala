...
//   * 
//   */
//  def apply(term1: E, term2: E, eqReferences: scala.collection.mutable.HashMap[(E,E),at.logic.skeptik.algorithm.congruence.EqW]): App = {
//    require(term1.t == term2.t)
...
//	        eqReferences += ((term1,term2) -> at.logic.skeptik.algorithm.congruence.EqW(y))
//	        eqReferences += ((term2,term1) -> at.logic.skeptik.algorithm.congruence.EqW(y))
