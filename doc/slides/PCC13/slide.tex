...
\begin{frame}{Deletion}
  \begin{subpart}{Deletion of an edge}
    \item The resovent is replaced by the other antecedent.
    \item Some subsequent resolutions may have to be deleted as well.
  \end{subpart}
...
\begin{frame}
  \begin{subpart}{Configuration}
    ...
    \item Experiements performed on the Vienna Scientific Cluster.
  \end{subpart}
  \begin{block}{Results}
    \vspace{1em}
    \centering
...
\begin{frame}{Conclusion}
  ...
  \end{subpart}
  \begin{subpart}{Further works}
    \item Combine LowerUnivalents after other algorithms.
    \item Get rid of order dependancy.
