...
Algorithm \ref{algo:fullLUniv} sums up the previous remarks on an efficient way of determining if a
...
at each cluster node (16 GB) has been usefull to compress the biggest proofs (with more than $10^6$
nodes).
