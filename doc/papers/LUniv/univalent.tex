...
\begin{description}
  ...
  \item[Best RPILU/LU.RPI:] which performs both RPILU and LU.RPI and chooses the smallest resulting compressed proof;
  \item[Best RPILU/LUnivRPI:] which performs both RPILU and LUnivRPI and then chooses the smallest resulting
    compressed proof.
\end{description}
...
set of subproofs it lowers is aalways a superset of the set of subproofs lowered by {\LowerUnits}. It might
...
deletion or reconstruction phase could probably benefit from being combined with {\LowerUnivalents} too.
