...
Algorithm \ref{algo:fullLUniv} sums up the previous remarks on how to implement
{\LowerUnivalents} efficiently. As noticed above, sometimes this algorithm may consider a subproof as univalent when it
