...
\BWP{Testing new commands: $\rn{\f{ \dn{\psi}{\eta} }}{\varsigma}{\varsigma'}$} 
...
\BWP{In the definition of safe literal, note that $\eta$ can be an arbitrary subproof... it is not necessarily a single node.}
