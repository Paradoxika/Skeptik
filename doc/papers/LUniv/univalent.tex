...
Nevertheless, \emph{partial} regularization algorithms, such as \texttt{RecyclePivots} \cite{RP08} and \texttt{RecyclePivotsWithIntersection} ({\RPI}) \cite{LURPI}, carefully avoid the worst case of total regularization and do efficiently compress proofs.  For
