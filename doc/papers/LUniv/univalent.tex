...
formal proof that it always compress more than {\LowerUnits} is shown. Section \ref{sec:LUnivRPI}
...
{\LowerUnivalents} can be implemented as an enhanced \FuncSty{delete} operation.  Non-sequential
...
{\LowerUnivalents} has been implemented as a recursive \FuncSty{delete} improvement. But as the set
