...
\titlerunning{Compression of Propositional Resolution Proofs by Lowering Subproofs}
...
\authorrunning{Boudou and Woltzenlogel Paleo}
...
\ref{sec:LUnivRPI} describes the non-sequential combination of {\LowerUnivalents} and {\RPI}. Experimental results are discussed in Sect. \ref{sec:exp}.
...
are shown in Table \ref{tab:benchmarks}.  The experiment compared the following algorithms:
\begin{description}
